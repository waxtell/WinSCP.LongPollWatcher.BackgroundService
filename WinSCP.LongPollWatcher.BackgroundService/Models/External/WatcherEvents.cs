...
namespace WinSCP.LongPollWatcher.BackgroundService.Models.External
{
    public class WatcherEvents
    {
        ...
        public Func<string, SessionOptions, CancellationToken, Task> OnFileModified { get; set; } = async (remoteFileName, sessionOptions, cancellationToken) => await Task.CompletedTask;
